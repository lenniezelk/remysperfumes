...
function RouteComponent() {
    ...
    return <div className="p-8">
        <Heading level={1} className="mb-4 flex justify-between items-baseline">
            ...
            <span className="text-accent text-sm"> Welcome {context.user?.name}</span>
        </Heading>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm no-underline hover:no-underline">{model.description}</p>
                            </div>
                        </div>
                    </AppLink>
                )
