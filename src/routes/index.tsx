...
function App() {
  return (
    <div className="min-h-screen bg-linear-to-br from-neutral-bg-light to-neutral-bg flex flex-col items-center justify-center px-4">
      ...
      {/* Decorative Elements */}
      <div className="absolute top-10 left-10 w-20 h-20 bg-brand-light/30 rounded-full blur-xl"></div>
      <div className="absolute bottom-10 right-10 w-32 h-32 bg-accent-light/20 rounded-full blur-xl"></div>
      <div className="absolute top-1/2 left-4 w-16 h-16 bg-brand/20 rounded-full blur-lg"></div>
    </div>
  )
}
